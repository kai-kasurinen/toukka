...
@click.option('--expand-label-to-albums', is_flag=True)
@click.option('--take-one-uri', is_flag=True)
...
@click.option('--randomize-labels', is_flag=True)
...
@click.option('--sort-label-albums-by-keys', type=StringListParamType(),
              default='album_type,release_date')
@click.option('--sort-label-albums-reverse', is_flag=True)
@click.option('--sort-artists-by-keys', type=StringListParamType(),
              default=None)
@click.option('--sort-artists-reverse', is_flag=True)
@click.option('--ignore-various-artists', '--ignore-various-artists-albums', is_flag=True)
@click.option('--ignore-classical-artists', is_flag=True)
